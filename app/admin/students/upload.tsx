...
export default  function Upload({ onChange }:any) {
  ...
  const handleFileUpload = () => {
    // Simulate file upload and call onChange with the uploaded file URL
    const uploadedUrl = 'https://example.com/profile.jpg'; // Simulated URL
